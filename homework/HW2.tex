...
\noindent \textbf{Due:} Friday, September 12, 10:00pm on Canvas.\\ 
...
\url{https://sta214-f25.github.io/homework/hw_02_template.qmd}\\
...
In the first part of the assignment, we will fit a logistic regression model to the Titanic data. If you get stuck, remember that the course codebook may be helpful: \url{https://sta214-f25.github.io/resources/codebook.html} 
...
\begin{enumerate}
\item Write down the population logistic regression model, making sure to include both the random and systematic components. Use proper notation and include all subscripts. (See ``writing math in Quarto and R Markdown'' in the course codebook, \url{https://sta214-f25.github.io/resources/codebook.html}) Note: passenger class is a categorical variable with more than two levels! 

\item In R, fit your logistic regression model, and write down the equation of the fitted model. (See ``writing math in Quarto and R Markdown'' in the course codebook, \url{https://sta214-f25.github.io/resources/codebook.html})
