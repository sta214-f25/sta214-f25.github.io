...
**Important:** This assignment is *optional*. I will take your 8 highest hw grades in the class; so, if you choose to complete this assignment, it can potentially replace one of your other hw grades.

**Instructions:** 

Begin by downloading the HW 9 template from the course website:

[https://sta214-f25.github.io/homework/hw_09_template.qmd](https://sta214-f25.github.io/homework/hw_09_template.qmd)
...
```r
library(tidyverse)
music <- read_csv("https://sta214-f25.github.io/slides/musicdata.csv")
```
