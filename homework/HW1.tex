...
\section*{Part 0: Survey}

In this class, we are beginning with the foundations of the logistic regression model, and we will soon begin to discuss logistic regression models in more depth. As we get more into modeling, we will also discuss the important skill of *statistical communication*: communicating the results of a statistical analysis to a target audience.\\

\noindent To help me judge where everyone is at with statistical communication at the beginning of the semester, please fill out this brief survey:\\

\url{https://forms.gle/o3eX3JQGTwzqYc5a8}\\

\noindent Make sure to select *Dr. Evans STA 214* for your class section!
